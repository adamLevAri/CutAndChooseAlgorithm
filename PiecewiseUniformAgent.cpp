...
public:
    ...
    PiecewiseUniformAgent(vector<vector<float>> desiredRegions, string name) :
    Agent(name) {
    ...
    virtual float cakeValue() { return this->totalValueCache; }
    
    virtual float cakeLength() { return this->length; }
    
    virtual float eval(float start, float end) {
